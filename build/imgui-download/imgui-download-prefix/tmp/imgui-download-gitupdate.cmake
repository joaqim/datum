...
execute_process(
  COMMAND "F:/Program Files/Git/cmd/git.exe" show-ref master
  WORKING_DIRECTORY "P:/datum/build/imgui-src"
...
# yet).
execute_process(
  COMMAND "F:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 master
  WORKING_DIRECTORY "P:/datum/build/imgui-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'P:/datum/build/imgui-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'P:/datum/build/imgui-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "F:/Program Files/Git/cmd/git.exe" checkout master
      WORKING_DIRECTORY "P:/datum/build/imgui-src"
      RESULT_VARIABLE error_code
      )
    if(error_code)
