...
pkg_check_modules(POPPLER_PKG poppler poppler-glib poppler-cpp)
...
if (NOT POPPLER_CPP_INCLUDE_DIR)
   message(STATUS "Could not find poppler-cpp include dir")
    set(POPPLER_FOUND FALSE)
endif (NOT POPPLER_CPP_INCLUDE_DIR)
...
set(POPPLER_INCLUDE_DIRS ${GTK2_INCLUDE_DIRS} ${POPPLER_GLIB_INCLUDE_DIR} ${POPPLER_INCLUDE_DIR} ${POPPLER_CPP_INCLUDE_DIR} "/usr/include/poppler/cpp")
